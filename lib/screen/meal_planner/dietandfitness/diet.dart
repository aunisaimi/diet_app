...
//                       children: [
//                         // Example usage with Text.rich and TextSpan
//                         Text.rich(
//                           TextSpan(
...
//                             children: [
//                               TextSpan(
//                                 text: widget.meal.name, // Normal meal name
...
//                         Text.rich(
//                           TextSpan(
//                             text: 'Calorie: ', // Bold "Calorie"
//                             style: const TextStyle(fontWeight: FontWeight.bold),
//                             children: [
//                               TextSpan(
//                                 text: '${widget.meal.calories}', // Normal calorie value
//                                 style: const TextStyle(fontWeight: FontWeight.normal),
//                               ),
//                             ],
//                           ),
...
//                             children: [
//                               TextSpan(
//                                 text: '${widget.meal.fat}', // Normal fat value
//                                 style: const TextStyle(fontWeight: FontWeight.normal),
//                               ),
//                             ],
//                           ),
